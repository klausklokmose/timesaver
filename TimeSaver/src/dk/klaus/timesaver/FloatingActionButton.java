...
//			Drawable icon = a
//					.getDrawable(R.styleable.FloatingActionButton_withDrawable);
//			char c = attrs.getAttributeValue(
//					"http://schemas.android.com/apk/res/android", "text")
//					.charAt(0);
			char c = '+';
//			float size = a.getDimension(
//					R.styleable.FloatingActionButton_textSize, 36);
			int tColor = a.getColor(R.styleable.FloatingActionButton_textColor,
					Color.WHITE);
			init(color);
//			if (icon != null)
...
//		mDrawablePaint.setTextAlign(Align.CENTER);
		setCharacter(text);
		invalidate();
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawText(text + "", getWidth() / 2, (getHeight()/2)+32, mDrawablePaint);
	}
